...
# [early-irecv] Pull in the platform patch (patch_multiproc_executor) so the
# worker process also gets WorkerProc -> AscendWorkerProc replacement.
# adapt_patch()
...
# plain WorkerProc whose _init_message_queues never rebuilt the sideband
# hint/done MQs, so every recv-hint was dropped (early-irecv silently
