...
class NPUWorker(WorkerBase):
    ...
    def execute_model(
        ...
        if os.environ.get("PP_TIMING_ENABLE", "0") == "1":
            print(f"[PP_TIMING][worker_entry start] {time.perf_counter()}")
        ...
        if isinstance(output, (ModelRunnerOutput, AsyncModelRunnerOutput, NoneType)):
            if os.environ.get("PP_TIMING_ENABLE", "0") == "1":
                print(f"[PP_TIMING][worker_entry end 1] {time.perf_counter()}")
            return output
        ...
        if is_edge_device():
            ...
            if os.environ.get("PP_TIMING_ENABLE", "0") == "1":
                    print(f"[PP_TIMING][worker_entry end edge] {time.perf_counter()}")
            if isinstance(output, (ModelRunnerOutput, AsyncModelRunnerOutput, NoneType)):
                return output
            return output
        ...
        if os.environ.get("PP_TIMING_ENABLE", "0") == "1":
            print(f"[PP_TIMING][worker_entry end 2] {time.perf_counter()}")
