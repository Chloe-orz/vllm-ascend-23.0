        ...
        **model_kwargs: dict[str, Any],
        ...
        if (
            ...
            logger.warning(
                ...
                "seg_e_graph=%s runtime_mode=%s "
                "num_tokens_padded=%d head_k=%d tail_k=%d",
                "head" if intermediate_tensors is None else "tail",
                use_graph, seg_a_graph, seg_e_graph,
                getattr(forward_context, "cudagraph_runtime_mode", None),
                num_tokens_padded, self.head_k, self.tail_k,
            )
